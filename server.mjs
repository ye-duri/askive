...
export function createApp(env=process.env){
 ...
 const server=http.createServer({maxHeaderSize:8192,requestTimeout:15000,headersTimeout:10000},async(req,res)=>{
  ...
  try{
   ...
   if(!['/index.html','/styles.css','/print.css','/app.js','/media-ready.mjs','/delivery.js','/frames.json','/gallery.html','/gallery.js','/gallery.css','/vendor/qrcode.mjs','/fonts/nanum-pen.ttf','/fonts/OFL.txt'].includes(pathname)&&!/^\/frames\/[a-zA-Z0-9_-]+\.(svg|png|webp|jpe?g)$/.test(pathname))throw fail(404,'파일이 없습니다.');
