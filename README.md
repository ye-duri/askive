...
- 베이직: 종류 → 2/4/6컷 → 5초 간격 8장 자동 촬영 → 사진 선택·프레임 선택 (같은 화면) → 완성
...
- 이용 종료는 기기 데이터만 정리합니다. QR 앨범은 24시간 만료 후 정기 삭제되며, 삭제 요청은 개인정보 문의처로 받습니다.
...
- 베이직/특별에디션 프레임 예시과 연세스튜디오 SVG 로고를 반영했습니다.
